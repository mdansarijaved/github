...
export default async function Issues({params}:{params:{username:string}}) {
  ...
  return (
    <div>   <main className="flex  flex-1 flex-col gap-4 p-4 md:gap-8 md:p-10">
    ...
    <div>
      <Card>
        <Table>
          ...
          <TableBody>
            {res && res.items && res.items.map((issue:Issue) => (
